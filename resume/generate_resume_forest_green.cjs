/**
 * ATS-Optimized Resume Generator - Forest Green Style
 * Sans-serif font (Helvetica) with forest green accent
 */
...
const MEDIUM_TEXT = '#57534e';
const LIGHT_GRAY = '#a8a29e';
const ACCENT_COLOR = '#166534'; // Forest green
...
function createResume() {
    ...
    const outputPath = 'Giridharan_Narayanan_Resume_ForestGreen.pdf';
