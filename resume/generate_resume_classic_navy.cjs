/**
 * ATS-Optimized Resume Generator - Classic Navy Style
 * Serif font (Times-Roman) with navy blue accent
 */
...
const ACCENT_COLOR = '#1e3a5f'; // Navy blue
...
function createResume() {
    ...
    const outputPath = 'Giridharan_Narayanan_Resume_ClassicNavy.pdf';
