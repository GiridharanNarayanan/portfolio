/**
 * ATS-Optimized Resume Generator - Warm Professional Style
 * Serif font (Times-Roman/Georgia style) with amber/rust accent
 */
...
const MEDIUM_TEXT = '#78716c';
const LIGHT_GRAY = '#a8a29e';
const ACCENT_COLOR = '#b45309'; // Amber/rust
...
// Font settings - Serif (Georgia-like)
...
function createResume() {
    ...
    const outputPath = 'Giridharan_Narayanan_Resume_WarmProfessional.pdf';
