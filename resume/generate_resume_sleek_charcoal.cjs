/**
 * ATS-Optimized Resume Generator - Sleek Charcoal Style
 * Sans-serif font (Helvetica) with monochrome charcoal palette
 */

const PDFDocument = require('pdfkit');
const fs = require('fs');

// Colors - Sleek Charcoal (monochrome)
const DARK_TEXT = '#333333';
const MEDIUM_TEXT = '#666666';
const LIGHT_GRAY = '#999999';
const ACCENT_COLOR = '#333333'; // Dark gray (no color accent)
...
function createResume() {
    ...
    const outputPath = 'Giridharan_Narayanan_Resume_SleekCharcoal.pdf';
