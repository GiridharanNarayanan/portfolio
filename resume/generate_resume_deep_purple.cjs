/**
 * ATS-Optimized Resume Generator - Deep Purple Style
 * Sans-serif font (Helvetica) with purple accent
 */
...
const ACCENT_COLOR = '#6b21a8'; // Purple
...
function createResume() {
    ...
    const outputPath = 'Giridharan_Narayanan_Resume_DeepPurple.pdf';
